    ...
    <section>   
        <div class="container">
            <div class="row pt-5">
                ...
                <a type="button" href= "AddBooks.php" class="btn btn-outline-secondary">Add</a>
                <table class="table mt-3">
                    ...
                    <tbody>
                        <!-- <tr>
                            ...
                            <td>Vinz</td>
                            <td>Romance</td>
                            <td><a type="button" href= "BooksDetail.php" class="btn btn-primary btn-sm">Detail</td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                            <td>Kisah Cinta</td>
                        ...
                        <?php
                          ...
                          foreach ( $db->fetchDataPenerbit() as $penerbit ){
                              echo '<tr>';
                                echo '<td>'.$penerbit->buku->isbn.'</td>';
                                echo '<td>'.$penerbit->buku->judul.'</td>';
                                echo '<td>';
                                ...
                                echo '<td>'.$penerbit->buku->kategori.'</td>';
                                echo '<td><a type="button" href= "BooksDetail.php?isbn='.$penerbit->buku->isbn.'" class="btn btn-primary btn-sm">Detail</td>';
                              echo '</tr>';
                          }
