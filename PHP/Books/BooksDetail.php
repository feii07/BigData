    ...
    <div class="jumbotron jumbotron-fluid">
          ...
          <div class="row justify-content-sm-center">
            <div class="col-sm-4">
              <div class="card" style="width: 215.9px; height:279.4px;">
                <img src="../../Multimedia/Books/hush.jpg" class="img-thumbnail" alt="picture">

                <br>
                <h5 style="color:white;">Genre : </h5>
                <p style="color:white;"> <?php echo $penerbit->buku->kategori ?> </p>
              </div>
            </div>

            <div class="col-sm-8 explain mt-sm-5">
              <h1> <?php echo $penerbit->buku->judul ?> </h1>
              <p>Rilis Buku</p>
            </div>
          </div>
        </div>
      ...
      <section id="overview" class="overview">
        <div class="row justify-content-sm-center">
          <div class="col-5">
            <h1>Overview</h1>
            <p> <?php echo $penerbit->buku->deskripsi ?> </p>
          </div>
          <div class="col-1"></div>
          <div class="col-3">
            <h1>Penulis</h1>
            <p></p>
            <?php
              foreach ( $penerbit->buku->penulis as $penulis ){
      ...
      <div class="row justify-content-center pt-5 pb-3">
        <a name="" id="" class="btn btn-outline-success btn-lg mr-2" href="Edit.php?isbn=<?php echo $penerbit->buku->isbn ?>" role="button">Edit</a>
        <a name="" id="" class="btn btn-outline-danger btn-lg ml-2"  href="Delete.php?isbn=<?php echo $penerbit->buku->isbn ?>" role="button">Delete</a>
    </div>
